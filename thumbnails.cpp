...
// -+- change: Add remembered location for FlipboolProc and ThumbsProc Windows
//
...
LRESULT APIENTRY FlipbookProc( HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
	...
	switch(msg)
		...
		case WM_CREATE:
			...
			CurrButtonWnd = NULL;						// setup thumbnails
		...
		case WM_SIZE:
			...
			KillTimer( hWnd, THUMBS_TIMER );	// at start up or resize, restart section list
