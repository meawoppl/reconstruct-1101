...
// -+- change: Add remembered location for OpenGLProc, SpinRateDlgProc
//
...
LRESULT APIENTRY OpenGLProc( HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
	...
	switch(msg)
		...
		case WM_SIZE:
			...
			SetPerspective( hWnd );							// resize viewport with user resizes window
